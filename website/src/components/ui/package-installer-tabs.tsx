...
const tabs: PackageTab[] = [
  {
    ...
    command: "npm",
    packageName: "install -g portscope",
    extra: "",
  },
  {
    id: "pnpm",
  ...
  },
  {
    ...
    command: "yarn",
    packageName: "global add portscope",
    extra: "",
  },
  {
    id: "bun",
...
const PackageInstallerTabs = () => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto rounded-2xl border border-border/40 bg-[#0d1117] shadow-xl shadow-black/20 overflow-hidden ring-1 ring-white/10">
